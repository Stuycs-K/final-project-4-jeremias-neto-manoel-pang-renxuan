public class rounds{
  private String[] info = new String[]{
    ...
    //"red", "red","red", "red","red","red", "red","red", "red","red", "done",
    
    //"green", "green","green", "green","green", "green","green", "green","green", "green",
    //"blue", "blue", "blue", "blue", "blue", "blue", "blue", "blue", "blue", "blue", "blue", "blue", "blue", "blue", "blue",
    //"max 70",
    //"yellow", "yellow", "yellow","yellow", "yellow", "done",
    
    //"max 30",
    //"blue", "blue", "green", "blue", "blue", "green", "blue", "blue", "green", "blue", "blue", "green", "blue", "blue", "green", 
    //"blue", "blue", "green", "blue", "blue", "green", "blue", "blue", "green", "blue", "blue", "green", "blue", "blue", "green",
    //"blue", "blue", "green", "blue", "blue", "green", "blue", "blue", "green", "blue", "blue", "green", "blue", "blue", "green",
    //"blue", "blue", "green", "blue", "blue", "green", "blue", "blue", "green", "blue", "blue", "green", "blue", "blue", "green",
    //"blue", "blue", "green", "blue", "blue", "green", "blue", "blue", "green", "blue", "blue", "blue", "blue", "done",
    
    //"red", "red", "red", "red", "red", "red", "red","red", "red", "red", "red", "red", "red", "red",
    //"red", "red", "red", "red", "red", "red", "red", "blue", "blue", "blue", "green", "green", "yellow", "yellow", 
    //"red", "red", "red", "red", "red", "red", "red", "blue", "blue", "blue", "green", "green", "yellow", "yellow", 
    //"red", "red", "red", "red", "red", "red", "red", "blue", "blue", "blue", "green", "green", "yellow", "yellow", 
    //"red", "red", "red", "red", "red", "red", "red", "blue", "blue", "blue", "green", "green", "yellow", "yellow", 
    //"red", "red", "red", "red", "red", "red", "red", "blue", "blue", "blue", "green", "green", "yellow", "done", 
    
    "max 20",
    "red", "red", "red", "red", "red", "blue", "blue", "blue", "blue", "green", "green","green", "yellow", "yellow", "pink",
    "red", "red", "red", "red", "red", "blue", "blue", "blue", "blue", "green", "green","green", "yellow", "yellow", "pink",
    "red", "red", "red", "red", "red", "blue", "blue", "blue", "blue", "green", "green","green", "yellow", "yellow", "pink",
    "red", "red", "red", "red", "red", "blue", "blue", "blue", "blue", "green", "green","green", "yellow", "yellow", "pink",
    "red", "red", "red", "red", "red", "blue", "blue", "blue", "blue", "green", "green","green", "yellow", "yellow", "pink", "done",
    ...
    "green", "green","green", "green","green", "green","green", "green","green", "green",
    "green", "green","green", "green","green", "green","green", "green","green", "green",
    "yellow", "yellow","yellow", "yellow","yellow", "yellow","yellow", "yellow", "done",
    
    "yellow", "yellow","yellow", "yellow","yellow", "yellow","yellow", "yellow","yellow", "yellow","yellow", "yellow",
    "yellow", "yellow","yellow", "yellow","yellow", "yellow","yellow", "yellow","yellow", "yellow","yellow", "yellow", "done",
    ...
    "green", "green","green", "green","green", "green","green", "green","green", "green",
    "green", "green","green", "green","green", "green","green", "green","green", "green",
    "green", "green","green", "green","green", "green","green", "green","green", "green", "done",
    ...
    "black", "black", "black", "black", "black", "black", "max 50", "red", "blue", "green", "yellow", "pink", "white", "black", "zebra", 
    "zebra", "zebra", "zebra", "zebra", "done"
  };
